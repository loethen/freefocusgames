...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: 'games.peripheralSpeedTraining',
  })
  ...
  return {
    ...
    alternates: generateAlternates(locale, 'games/peripheral-speed-training'),
  }
}

export default function PeripheralSpeedTrainingPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
  ...
  const t = useTranslations('games.peripheralSpeedTraining')
  ...
  const pageUrl = `${baseUrl}${localePrefix}/games/peripheral-speed-training`
  ...
  return (
    <GamePageTemplate
      gameId="peripheral-speed-training"
      title={t('title')}
      subtitle={t('subtitle')}
